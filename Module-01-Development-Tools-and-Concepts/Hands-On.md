...
-Explored basic Git commands and workflows
...
-Practiced basic terminal commands (ls, cd, pwd)
...
-Cloned the repository using SSH authentication
-Added and modified files locally within the repository
