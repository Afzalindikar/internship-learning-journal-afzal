...
-Overview of development tools required for the course
-Understanding the role of Git in version control
-Basics of JSON file structure used in assignments
-Introduction to package managers and command-line tools
...
-Using terminal commands for navigation
-Managing files between Windows and Linux
...
-Systems-level thinking in software development
-Real-world examples of API usage
-Importance of API knowledge for job readiness
-How different components communicate in a system
...
-Comparing HTTPS and SSH-based cloning
-Creating SSH keys and adding them to GitHub
-Cloning repositories via SSH
-Working with local files and tracking changes
-Handling authentication and permission-related errors
